...
chrome_install ()
{
    ...
    wget -O google-chrome-stable_current_amd64.deb https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb ; dpkg -i "$DWNLD_DIR/google-chrome-stable_current_amd64.deb"
